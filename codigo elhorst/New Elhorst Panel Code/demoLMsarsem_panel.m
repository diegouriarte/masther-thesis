A=wk1read('E:\studying files\gis\New Elhorst Panel Code\cigarette.wk1',1,0); % data set with T=30
W1=wk1read('E:\studying files\gis\New Elhorst Panel Code\Spat-Sym-US.wk1');
