...
Por tanto el valor de sc es $sc = \frac{(9+1+14+1+1)/5}{8} = 0.65$. Verificamos que sea el mismo valor

```{r}
if (all.equal(calcular_sc(14645), 0.65)) {
