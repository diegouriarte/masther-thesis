...
## Calculo de SC pre venta a nivel banderas
...
ptm <- proc.time()
sc_vector <- map_dbl(grifos_sc$codigo_de_osinergmin.princ, calcular_sc, "bandera")
proc.time() - ptm
...
```{r}
saveRDS(grifos_sc_pre, file = here::here("data","processed","grifos_con_sc_pre_venta_razon.RDS"))
saveRDS(grifos_sc_post_1, file = here::here("data","processed","grifos_con_sc_post_venta_razon.RDS"))
