...
```{r}
grifos_post <- grifos %>% 
    mutate(bandera.princ = recode_factor(bandera.princ, "PECSA" = "PRIMAX"),
           bandera.vec = recode_factor(bandera.vec, "PECSA" = "PRIMAX"))
...
saveRDS(grifos_sc_post, file = here::here("data","processed","grifos_con_sc_post_venta.RDS"))
