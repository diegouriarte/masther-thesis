...
```
Ahora solo hay observaciones relacioandas a COESTI que debemos resolver.
...
Verifiquemos duplicados directos por dirección
2
...
Ese grifo de Repsol no existe, as? que lo dropeamos de la base de datos de precios y de grifos, (est? repetido con el grifo argus)
...
Vemos que funciona, as? que hacemos una funci?n para corregir:
...
Ahora grifo que cambi? de raz?n social. Cod 9488
