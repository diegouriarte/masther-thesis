...
Guardemos ese dataset para utilizarlo en otro archivo cuya función sea sacar las medidas de concentración y otras cosas divertidas

```{r}
saveRDS(grifos_con_vecinos_2, file = here::here("data","processed","grifo_con_vecinos.RDS"))
```


# Mapa en google maps - Visualización
